...
if ($method == 'POST') {
  ...
  if ($_POST['type'] == "submit_application") {
    ...
    if (isset($_FILES["image"]) && $_FILES["image"]["error"] === UPLOAD_ERR_OK) {
        ...
        $sql = "INSERT INTO newapplications (full_name, dob,religion, father_name, mother_name , gender,city_town, nationality, address, contact, alt_contact, email, p_g_name, pre_sch_name, pre_sch_address, class_last_attended, grade_for_apply, photo) 
        VALUES ('$full_name', '$dob','$religion','$father_name','$mother_name', '$gender', '$city_town','$nationality', '$address', '$contact', '$alt_contact', '$email', '$p_g_name', '$pre_sch_name', '$pre_sch_address', '$class_last_attended', '$grade_for_apply', '$photo')";
